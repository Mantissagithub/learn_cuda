...
file - [`matrix_multiplication`](../03_kernels/kernels/matrix_mul_shared_mem.cu)
...
file - [`max_element`](../03_kernels/kernels/max_element.cu)
...
file - [`transpose`](../03_kernels/kernels/transpose_matrix.cu)
```
...
file - [`stencil_matrix`](../03_kernels/kernels/stencil_matrix.cu)
```
